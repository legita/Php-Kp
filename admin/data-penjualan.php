                    ...
                    <table class="table table-striped table-bordered table-hover" id="myTable">
                        ...
                        while ($data=mysqli_fetch_array($tampil)) { ?>
                          <tr>
                            ...
                            <td>
                                <a href="index.php?halaman=detail&id=<?php echo $data['id_transaksi'];?>&id_user=<?php echo $data['id_user']; ?>" class="btn btn-info">Detail Pesanan</a><br><br>
                                <center><?php 
                                if ($data['selesai']==0){ ?>
                                <a class="btn btn-danger" title="Selesai"><i class="fa fa-check"></i></a>
                                    <?php }
                                else { ?>
                                    <button  class="btn btn-warning" title="Pesanan Selesai"><i class="fa fa-check"></i></button>
                                <?php } ?></center> 
                            </td>
                          </tr>
