...
$totalcek    = $dataInvoice['totalcek'];

$sqlInsert  = "INSERT INTO transaksi(id_user,tanggal,nama_pembeli,totalcek,upload,invoice)
			   VALUES ('$id_user','$tgl','$nama','$totalcek','$target_file','$invoice')";
