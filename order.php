...
<div class="container-fluid bg-3 text-center">   
  ...
  <div class="row">
    ...
    <div class="col-sm-7">
      <form class="form-horizontal" role="form" name="autoSumForm" action="config/prosespesanan.php" method="POST">
          ...
          <div class="col-sm-8">
            <select class="form-control" id="jenis_wadah" name="jenis_wadah" aria-describedby="basic-addon1" required>
             <option>-- Pilih Wadah --</option>
                <?php
                  include 'config/koneksi.php';
                  $jenis_wadah = "SELECT * FROM wadah GROUP BY jenis_wadah";
                  $queryWd = mysqli_query($konek,$jenis_wadah);
                  while ($tmpWd = mysqli_fetch_array($queryWd)) { ?>
                      <option value="<?php echo $tmpWd['jenis_wadah']; ?>"><?php echo $tmpWd["jenis_wadah"]; ?>
                      </option>
                  <?php
                  }
                  ?>
